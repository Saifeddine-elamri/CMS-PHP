    ...
    <main class="form-container">
        ...
        <form action="/post/create" method="POST" class="post-form" enctype="multipart/form-data">
            ...
            <div class="form-group">
                ...
                <small class="error-message"><?php echo htmlspecialchars($errors['title'] ?? '', ENT_QUOTES, "UTF-8"); ?></small>
            </div>
            ...
            <div class="form-group">
                ...
                <small class="error-message"><?php echo htmlspecialchars($errors['content'] ?? '', ENT_QUOTES, "UTF-8"); ?></small>
            </div>
